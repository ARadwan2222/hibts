...
class TodoReminderWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        when (type) {
            "BEFORE" -> NotificationHelper.showTodoBeforeNotification(context, todoId, todoTitle, minutes)
            "START"  -> NotificationHelper.showTodoStartNotification(context, todoId, todoTitle)
            "END"    -> NotificationHelper.showTodoEndNotification(context, todoId, todoTitle)
        }
